...
flags.DEFINE_alias('grac', 'gradient_checkpointing')
...
flags.DEFINE_boolean('save_checkpoint', False, '')
...
flags.DEFINE_boolean('train_allnew', False, '')
...
flags.DEFINE_alias('too', 'torch_only')
...
flags.DEFINE_boolean('tf_only', False, '')
...
flags.DEFINE_boolean("write_summary", False, "")
flags.DEFINE_boolean("write_metric_summary", False, "")
...
flags.DEFINE_float('rdrop_rate', 0., '')
