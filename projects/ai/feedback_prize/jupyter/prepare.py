...
train.reset_index().to_feather('../input/feedback-prize-2021/train.fea')


# In[30]:


pd.read_feather('../input/feedback-prize-2021/train.fea')
...
for i in range(5):
  print('-------------------', i)
  display(train[train.kfold == i].describe())
